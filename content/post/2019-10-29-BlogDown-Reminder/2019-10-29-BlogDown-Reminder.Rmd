...
Le YALM, définit plusieurs sections: auteur, rôle, organisation et les liens des réseaux sociaux qui apparaissent à gauche
...
- Nom et prénom:  `name:`
- Rôle: `role:`
- L'organisation:  dans le YALM. En section `organizations`. On précise le `name:` et l' `url:`
- Les icônes de liens (LinkedIn, ResearchGate, etc.): `content\authors\admin\_index.md` : dans le YALM. En section `social`, on précise l'icône (à la fois le nom de l'icône dans le paquet d'où il est [téléchargé](https://fontawesome.com/) ) et le lien interne (une autre page du blog - cv ou résumé ou contact) ou externe (une url)
...
- l'image: `content\authors\admin\_index.md` en dehors du / après le YALM
- le petit texte: `content\authors\admin\_index.md`  en dehors du /après le YALM
